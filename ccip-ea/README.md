...
This repository contains the source code for a Chainlink external adapter called "chainlinksolutions".

This project was cloned from the smartcontractkit/external-adapters-js project.

The test smart contract can be found in **./contracts/src**.
